        ...
        <div className="container mx-auto px-4 py-32 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 gradient-text leading-tight">
              Turn YouTube Videos into<br />Viral TikTok Content
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto mb-12">
              Our AI automatically transforms your long-form content into engaging short clips, 
              optimized for maximum reach on TikTok
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-70">
            <img src="https://upload.wikimedia.org/wikipedia/commons/e/e1/Logo_of_YouTube_%282015-2017%29.svg" 
                 alt="YouTube" className="h-8 md:h-10" />
            <img src="https://upload.wikimedia.org/wikipedia/en/a/a9/TikTok_logo.svg" 
                 alt="TikTok" className="h-8 md:h-10" />
            <img src="https://upload.wikimedia.org/wikipedia/commons/e/e7/Instagram_logo_2016.svg" 
                 alt="Instagram" className="h-8 md:h-10" />
          </div>
        </div>
      </section>
      ...
      <section className="py-32 features-gradient">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-20 gradient-text">
            Minimize editing time,<br />maximize content creation
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            <div className="relative group">
              ...
              <div className="relative bg-background rounded-lg p-8">
                ...
                <h3 className="text-xl font-semibold mb-4">Paste YouTube Link</h3>
                <p className="text-muted-foreground">Simply paste your YouTube video URL and let our AI do the heavy lifting</p>
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-background rounded-lg p-8">
                ...
                <p className="text-muted-foreground">Our AI analyzes your content to find the most engaging moments</p>
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-background rounded-lg p-8">
                ...
                <h3 className="text-xl font-semibold mb-4">Get Viral Clips</h3>
                <p className="text-muted-foreground">Download perfectly formatted clips ready for TikTok success</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Our advanced AI analyzes your content to identify the most engaging moments, ensuring your clips capture the best parts of your videos.
              </p>
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold mb-2">Smart Content Analysis</h3>
                    <p className="text-muted-foreground">Automatically detects key moments, emotions, and engagement triggers</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="p-2 rounded-lg bg-primary/10">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Creates clips optimized for maximum viewer retention and engagement</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Maximize your reach with automatically generated captions and translations, making your content accessible to a global audience.
              </p>
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="p-2 rounded-lg bg-primary/10">
                  ...
                  <div>
                    <h3 className="font-semibold mb-2">Accurate Transcription</h3>
                    <p className="text-muted-foreground">AI-powered speech recognition for precise captions</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="p-2 rounded-lg bg-primary/10">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Translate your content into multiple languages automatically</p>
                  </div>
                </div>
              </div>
            </div>
