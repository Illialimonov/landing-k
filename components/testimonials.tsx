const testimonials = [
  {
    ...
    content: 'ViralClips has completely transformed how I repurpose my YouTube content. The AI-powered editing is incredible!'
  },
  {
    name: 'Sarah K.',
    role: 'Gaming Streamer',
    image: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&h=400&fit=crop',
    content: 'The gaming overlays feature is genius! My TikTok engagement has increased significantly since using ViralClips.'
  },
  {
    name: 'David R.',
    role: 'YouTuber',
    image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop',
    content: 'What used to take hours now takes minutes. ViralClips is a game-changer for content creators.'
  }
]
    ...
    <section className="py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <p className="text-xl text-muted-foreground text-center mb-20 max-w-2xl mx-auto">
          Join thousands of content creators who are already using ViralClips to grow their audience
        </p>
