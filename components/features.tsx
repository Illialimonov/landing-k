...
const features = [
  {
    ...
    description:
      "Our advanced AI detects the most engaging moments from your videos automatically",
  },
  {
    icon: Clock,
    title: "Save Hours of Work",
    description:
      "Transform hours of content into viral-ready clips in just minutes",
  },
  {
    icon: Video,
  ...
  },
  {
    ...
    description:
      "Get perfectly formatted vertical clips ready for TikTok success",
  },
  {
    icon: Wand2,
    title: "Subtitles made by AI",
    description:
      "Automatically generated captions to boost engagement and accessibility",
  },
  {
    icon: Palette,
      ...
      <div className="container mx-auto px-4 relative">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Powerful features that help you create engaging content faster than
            ever
          </p>
        </div>
